    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('programming', 'Programming Languages'), ('framework', 'Frameworks & Libraries'), ('database', 'Databases'), ('cloud', 'Cloud & DevOps'), ('tool', 'Tools & Technologies'), ('soft', 'Soft Skills')], default='tool', max_length=50)),
