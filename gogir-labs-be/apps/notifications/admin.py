...
class NotificationPreferenceForm(forms.ModelForm):
    ...
    notification_types = forms.MultipleChoiceField(
        ...
        widget=forms.CheckboxSelectMultiple(attrs={'class': 'notification-types-checkboxes'}),
        required=True,
...
class NotificationPreferenceAdmin(admin.ModelAdmin):
    list_display = ['user', 'notification_type', 'email_enabled', 'in_app_enabled', 'updated_at', 'bulk_actions']
        ...
        if obj is None:
            ...
            class EditForm(forms.ModelForm):
                class Meta:
                    ...
                    widgets = {
                        'notification_type': forms.Select(attrs={'readonly': True, 'disabled': True})
                    }
    ...
    class Media:
        css = {
            'all': ('admin/css/notification_preferences.css',)
        }
