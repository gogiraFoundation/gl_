...
class NotificationModelTest(TestCase):
    ...
    def test_notification_creation(self):
        ...
        self.assertEqual(str(notification), f'{NotificationType.CONTACT_MESSAGE} - Test Notification')
...
class NotificationPreferenceModelTest(TestCase):
    ...
    def test_preference_creation(self):
        ...
        self.assertEqual(str(preference), f'{self.user.username} - {NotificationType.CONTACT_MESSAGE}')
