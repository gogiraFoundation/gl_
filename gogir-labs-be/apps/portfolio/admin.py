...
class ProjectAdmin(admin.ModelAdmin):
    ...
    actions = ['publish_projects', 'unpublish_projects', 'mark_featured', 'unmark_featured']
    ...
    fieldsets = (
        ('Basic Information', {
            'fields': ('title', 'slug', 'description', 'long_description', 'category', 'technologies')
        }),
        ('Media', {
            'fields': ('featured_image', 'video', 'video_url')
        }),
        ('Links', {
            'fields': ('github_url', 'live_url')
        }),
        ('Settings', {
            'fields': ('featured', 'published', 'order')
        }),
        ('Timestamps', {
